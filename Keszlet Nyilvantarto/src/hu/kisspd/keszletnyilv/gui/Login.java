...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton_enterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_enterActionPerformed
        ...
        try
        {
            ...
            if (rs.next())
            {
                JOptionPane.showMessageDialog(null, "Üdv" + name + "!");
                name = jTextField_felh.getText();
                passw = jPasswordField_pass.getText();
        ...
        if (validLogin)
        {
            try
            {
                ...
                String sqlID = "Select Id from User where username='"+ name +"' AND password='"+ passw +"'";
